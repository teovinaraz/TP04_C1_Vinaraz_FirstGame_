...
public class PauseMenuManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        settings = gameManager != null ? gameManager.Settings : GameSettings.Load();
        ...
        out Slider slider, out TMP_Text valueText)
    {
        ...
        CreateText(row.transform, labelText, 30f, new Vector2(-150f, 0f), new Vector2(230f, 55f));
    ...
    private void OnContinueClicked() => gameManager.ContinueGame();
    ...
    private void OnPlayerOneSpeed(float value)
    {
        ...
        if (gameManager != null && gameManager.PlayerOne != null) gameManager.PlayerOne.MovSpeed = value;
        UpdateSpeedLabels();
    }
    ...
    private void OnPlayerTwoSpeed(float value)
    {
        ...
        if (gameManager != null && gameManager.PlayerTwo != null) gameManager.PlayerTwo.MovSpeed = value;
        UpdateSpeedLabels();
    }
    ...
    private void OnPaddleSize(float value)
    {
        ...
        if (gameManager != null && gameManager.PlayerOne != null) gameManager.PlayerOne.SetPaddleScale(value);
        if (gameManager != null && gameManager.PlayerTwo != null) gameManager.PlayerTwo.SetPaddleScale(value);
    ...
    private void OnExitClicked() => gameManager.ExitToMainMenu();
